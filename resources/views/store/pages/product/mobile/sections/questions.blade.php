<section class="bg-light-orange block lg:hidden">
    <div class="container pb-16">
        <div class="w-full py-[15px] text-start">
            <h2 class="text-[42px] leading-[130%]">Frequent questions</h2>
            <p class="opacity-60">Key points about which you may have questions</p>
        </div>

        <div class="py-5">
            <div class="grid w-full gap-x-24">
                <div class="w-full items-start justify-between gap-x-5">
                    <div class="flex items-center justify-start gap-x-5">
                        <img
                            class="h-[48px] w-[48px]"
                            src="{{ asset('assets/images/product-page/frequent_icon_1.png') }}"
                            alt="size"
                        />
                    ...
                    <div class="relative w-full">
                        <img
                            class="mx-auto my-2 w-full rounded-2xl md:w-2/3"
                            src="{{ asset('assets/images/product-page/banners/productPage-m-banner_1.jpg') }}"
                            alt="size"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <x-ui.button
                            ...
                            left_icon="false"
                            right_icon="false"
                            class="mx-auto my-5 w-full font-bold sm:w-1/2"
                        >
            ...
            <div class="mt-10 grid w-full gap-x-24">
                <div class="w-full items-start justify-between gap-x-5">
                    <div class="flex items-center justify-start gap-x-5">
                        <img
                            class="h-[48px] w-[48px]"
                            src="{{ asset('assets/images/product-page/frequent_icon_2.png') }}"
                            alt="size"
                        />
                    ...
                    <div class="relative w-full">
                        <img
                            class="mx-auto my-2 w-full rounded-2xl md:w-2/3"
                            src="{{ asset('assets/images/product-page/banners/productPage-m-banner_2.jpg') }}"
                            alt="size"
                        />
                        <p class="text-charcoal text-[16px] font-normal opacity-80">
            ...
            <div class="mt-10 grid w-full gap-x-24">
                <div class="w-full items-start justify-between gap-x-5">
                    <div class="flex items-center justify-start gap-x-5">
                        <img
                            class="h-[48px] w-[48px]"
                            src="{{ asset('assets/images/product-page/frequent_icon_3.png') }}"
                            alt="size"
                        />
                        <h4 class="py-2 text-[20px] font-[500]">
                            Can I exchange or return this jumpsuit if it doesn't fit?
                    ...
                    <div class="relative w-full">
                        <img
                            class="mx-auto my-2 w-full rounded-2xl md:w-2/3"
                            src="{{ asset('assets/images/product-page/banners/productPage-m-banner_3.jpg') }}"
                            alt="size"
                        />
                        <p class="text-charcoal text-[16px] font-normal opacity-80">
            ...
            <div class="mt-10 grid w-full gap-x-24">
                <div class="w-full items-start justify-between gap-x-5">
                    <div class="flex items-center justify-start gap-x-5">
                        <img
                            class="h-[48px] w-[48px]"
                            src="{{ asset('assets/images/product-page/frequent_icon_4.png') }}"
                            alt="size"
                        />
                        <h4 class="py-2 text-[20px] font-[500]">
                            Can I exchange or return this jumpsuit if it doesn't fit?
                    ...
                    <div class="relative w-full">
                        <img
                            class="mx-auto my-2 w-full rounded-2xl md:w-2/3"
                            src="{{ asset('assets/images/product-page/banners/productPage-m-banner_4.jpg') }}"
                            alt="size"
                        />
                        <p class="text-charcoal text-[16px] font-normal opacity-80">
