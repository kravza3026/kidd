<div class="flex items-center justify-center">
    <div class="mx-auto w-lg max-w-xl">
        <div class="flex items-center justify-between">
            <h1 class="text-3xl font-bold md:text-[32px]">Share feedback</h1>
        ...
        <form method="POST" action="{{ LaravelLocalization::localizeURL('/login') }}">
            ...
            <div class="grid grid-cols-12 gap-x-4">
                <div class="col-span-12 mt-4">
                    <p class="text-sm font-medium">Rate your experience</p>
                    <div
                        x-data="{
                            rating: 0,
                            hoverRating: 0,
                ...
                <div class="col-span-12 mt-4">
                    <x-primary-button class="ms-3 w-full" :class="'!w-full'">Send message</x-primary-button>
                </div>
            </div>
        </form>
    </div>
