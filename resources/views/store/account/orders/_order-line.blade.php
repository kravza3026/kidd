<div class="border-light-border accordion-item my-2 rounded-2xl border">
    ...
    <label
        for="order_{{ $order->id }}"
        class="bg-light-orange relative hidden cursor-pointer items-center peer-checked:rounded-b-none rounded-2xl p-6 duration-300 lg:grid lg:grid-cols-12 peer-checked:[&_.accordion-arrow]:rotate-180"
    >
    ...
    <label
        for="order_{{ $order->id }}"
        class="accordion-header border-light-border  block peer-checked:!rounded-b-none rounded-2xl border p-0 duration-300 lg:hidden
         peer-checked:[&_.accordion-arrow]:rotate-0 peer-checked:[&_.accordion-arrow]:text-olive peer-checked:[&_.accordionTitle]:rounded-b-none"
    >
        <!-- arbitrary variant для svg -->
        <span class="accordionTitle bg-light-orange relative grid grid-cols-2 items-center rounded-2xl p-6">
    ...
    >
        <div class="p-3 lg:p-6">
            <div class=" grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                <p class="text-lg m-0 font-bold col-span-10">
                    {{ __('order.titles.delivery') }}
                </p>
                <a
                    href="{{ route('orders.track', $order) }}"
                    class="col-span-10 font-bold order-last lg:order-none flex lg:justify-end items-center"
                >
                   <div class="flex border rounded-full px-3 py-2 border-light-border gap-2 w-fit">
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-span-4 text-base">
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-start-1 lg:col-span-4 text-base">
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-span-5 text-base">
        ...
        <div class="border-light-border border-y p-3 lg:p-6 w-full">
            <div class="grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                @auth
                        <p class="text-lg m-0 font-bold col-span-10">{{ __('order.titles.contact') }}</p>
                        <a
                ...
                <p class="flex items-center justify-between lg:grid  col-span-20 lg:col-span-5 text-base">
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-span-5 text-basee">
        ...
        <div class="border-light-border border-t lg:border-t-none p-3 lg:p-6 w-full">

            <div class="grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                <h2 class="text-lg m-0 font-bold col-span-10">{{ __('order.titles.payment') }}</h2>
                <a
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-span-5 text-base">
                    ...
                    <span class="characteristics-dotted mx-2 mt-3 flex-1 opacity-10 lg:hidden"></span>
                    <span class="font-bold text-end lg:text-start">
                ...
                <p class="flex items-center justify-between lg:grid min-w-full col-span-20 lg:col-span-10 text-base">
                ...
                <hr class="border-light-border border-b col-span-20" />
                <div class="flex col-span-20 items-center justify-between">
