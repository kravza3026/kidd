<div class="border-light-border accordion-item my-2 rounded-2xl border">
    ...
    <label
        for="order_{{ $order->id }}"
        class="bg-light-orange relative hidden cursor-pointer items-center rounded-2xl p-6 duration-300 peer-checked:rounded-b-none lg:grid lg:grid-cols-12 peer-checked:[&_.accordion-arrow]:rotate-180"
    >
    ...
    >
        <div class="p-3 lg:p-6">
            <div class="grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                <p class="col-span-10 m-0 text-lg font-bold">
                    {{ __('order.titles.delivery') }}
                </p>
                <a
                    href="{{ route('orders.track', $order) }}"
                    class="order-last col-span-10 flex min-w-fit items-center font-bold lg:order-none lg:justify-end"
                >
        ...
        <div class="border-light-border w-full border-y p-3 lg:p-6">
            <div class="grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                @auth
                    <p class="col-span-10 m-0 text-lg font-bold">{{ __('order.titles.contact') }}</p>
                    <a
                        href="{{ route('profile.edit') }}"
                        class="order-last col-span-10 flex items-center font-bold lg:order-none lg:justify-end"
                    >
                        <div class="border-light-border flex w-fit gap-2 rounded-full border px-3 py-2">
                            <img
        ...
        <div class="border-light-border lg:border-t-none w-full border-t p-3 lg:p-6">
            <div class="grid grid-cols-20 items-center justify-start gap-3 lg:gap-7">
                <h2 class="col-span-10 m-0 text-lg font-bold">{{ __('order.titles.payment') }}</h2>
                <a
