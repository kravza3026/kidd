<div class="max-w-7xl px-4 sm:px-10 mt-6 sm:mt-0">
    <h2 class="sm:hidden text-2xl font-bold leading-4 tracking-[-2%] text-[#020202]/80">
        Account
    </h2>
    <div class="flex flex-col sm:flex-row sm:border-b-[1px] sm:border-gray-100 py-4 pb-0">
        <a class="{{ request()->routeIs('profile.edit') ? 'sm:border-0 sm:border-b-olive sm:border-b-2 text-olive opacity-100 ' : 'sm:border-0 sm:border-b-[1px] text-gray-900 ' }}group inline-flex justify-between items-center gap-x-4 p-4 pl-3 sm:pb-5 text-sm font-semibold border border-gray-100 -mb-px first:rounded-t-xl first:mt-0 last:rounded-b-xl hover:text-olive focus:z-10 focus:outline-none focus:ring-2 focus:ring-green-600"
           href="{{ url(route('profile.edit')) }}">
            <div class="inline-flex items-center gap-x-4">
                ...
                <span class="font-medium text-lg leading-[18px] tracking-[-2%]">
                    Profile
                </span>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
