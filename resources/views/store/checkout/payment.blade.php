...
@section('checkout-form')
    ...
    >
        ...
        <div class="grid grid-cols-17 items-center space-y-6 gap-x-2">
            ...
            <div class="col-span-17 lg:col-span-16 lg:col-start-2">
                <div class="grid min-h-10 lg:grid-cols-4 gap-2">
                    <div class="relative">
                        <input
                            type="radio"
                            name="payment_method"
                        ...
                        <div
                            class="border-light-border flex gap-x-3 items-start lg:grid peer-checked:border-olive peer-checked:bg-light-orange relative rounded-2xl border-2 bg-white p-3 duration-300 peer-checked:[&_.imgGradient]:block peer-checked:[&_.imgOutline]:hidden"
                        >
                            <div>
                                <img
                            ...
                            <div>
                                <p class="lg:mt-1 flex items-center gap-x-2 text-sm font-bold">
        ...
        <div class="grid lg:grid-cols-17">
            <div class="lg:col-span-16 lg:col-start-2">
                <div
                    x-data="{
                        ...
                        <div class="lg:bg-light-orange flex-wrap grid grid-cols-12 items-center justify-between rounded-t-2xl lg:p-4">
                            ...
                            <div class="flex justify-end col-span-6 lg:col-start-5 lg:col-span-4 items-center gap-x-2 mr-2">
                                <x-ui.checkbox
                                    ...
                                    class="bg-white"
                                ></x-ui.checkbox>
                                <label for="billing_sas" class="text-sm leading-[-2%] font-bold lg:font-normal">
