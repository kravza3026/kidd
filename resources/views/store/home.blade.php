    ...
    <div class="pageContent">
        ...
        <section class="pt-section">
            <div class="grid grid-cols-1 md:flex items-center relative justify-start bg-olive  h-fit min-h-[380px] xl:min-h-[560px]">
                ...
                <div class="w-full md:w-7/12 min-h-[380px] xl:min-h-[560px] order-1 md:order-2"
                style="background-image: url({{ asset('assets/images/subscribe_bg.jpg') }}); background-size: cover; background-position: center; background-repeat: no-repeat;"
                >
