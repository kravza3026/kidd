@php
    // Grouped navigation. Items only render when their route exists AND the user has the
    // permission AND the Pennant module is active (see <x-admin.nav-item>), so the menu
    // grows automatically as each module ships.
    $groups = [
        'Catalog' => [
...
<div class="relative flex grow flex-col overflow-y-auto border-r border-line bg-surface px-3 py-4">
    ...
    <nav class="flex flex-1 flex-col gap-y-4">
        <x-admin.nav-item route="admin.home" :label="__('Dashboard')" icon="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
