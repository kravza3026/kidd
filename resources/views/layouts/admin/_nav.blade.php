@php
    ...
    $groups = [
        ...
        'Sales' => [
            ...
            ['route' => 'admin.order-returns.index', 'label' => __('Order returns'), 'permission' => 'orderReturn.viewAny', 'feature' => 'admin.orderReturn', 'icon' => 'M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3'],
        ...
        'Content' => [
            ...
            // Companies is a future "team" flag for the owner — intentionally not exposed as an admin CRUD.
        ],
        'Platform' => [
