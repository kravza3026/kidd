...
<div class="flex lg:hidden items-center gap-x-2">
    <div class="dropdown relative z-[100001] border border-black/10 rounded-full ">
    ...
    <div class="relative z-[100001] flex items-center" x-data="{ open: false }" x-effect="document.body.classList.toggle('overflow-hidden', open)">
        <div x-on:click="open = !open" class="menu-control relative group z-[100002]">
            <div class="relative border border-black/10 flex overflow-hidden items-center justify-center rounded-full w-[33px] h-[33px] transform transition-all duration-200 ">
                <div class="flex flex-col justify-between w-[15px] h-[15px] transform transition-all duration-300 origin-center overflow-hidden">
                    ...
                    <div
                        ...
                        x-bind:class="open ? 'translate-y-6 opacity-0' : ''"
                    ></div>
                    ...
                    <div
                        ...
                        x-bind:class="open ? 'w-[17px] h-[17px] opacity-100' : ''"
                    >
                        <div
        ...
        <div
            ...
            class="fixed inset-0 top-[72px] z-[100000] bg-black/50"
        >
