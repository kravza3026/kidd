<x-admin-layout>
    <div class="relative border-b border-gray-200 pb-5 sm:pb-0">
        <div class="md:flex md:items-center md:justify-between">
            <h3 class="flex items-center justify-start gap-3 text-base font-semibold text-gray-700">
                <a
                    class="border-dark-olive text-dark-olive flex size-6 items-center justify-center rounded-full border"
