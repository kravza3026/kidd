<template>
    <div class="container">
        <div class="relative ">
            ...
            <input
                ...
                @input="handleType"
                type="text"
                class="w-full  focus:outline-hidden h-[50px] m-2 pl-2 pr-12 rounded-md bg-light-orange"
    ...
    <div class="tabs container flex lg:grid grid-cols-4 gap-6 mt-10 overflow-x-auto">
    ...
    <div class="tabContent py-section">
        ...
        <div v-else-if="activeTab === 'AccountTab'">
            <p>This is the Profile tab content.</p>
        </div>
        <div v-else-if="activeTab === 'TechnicalTab'">
...
<script>
import { ref } from 'vue';
import Deliveri from "@/components/statickPages/help/tabs/deliveri.vue";
import BaseInput from "@/components/ui/BaseInput.vue";

export default {
    name: 'HelpMain',
    components: {BaseInput, Deliveri},
