        ...
        <form @submit.prevent="createAddress(4)" v-for="(address, index) in addresses.filter(a => a.address_type === 4)"
            ...
            <div  class="flex items-center justify-between ">
                ...
                <div class="flex items-center gap-x-2">
                    ...
                    <div v-if="address.editor.isEditing" class="flex order-first gap-x-2 items-center">
                        <Button @click="createAddress(4)" :customClass="'w-fit !px-4 !my-0 !py-1.5 h-fit flex flex-nowrap !rounded-full !shadow-none text-sm font-medium'">
               ...
               />
                ...
                <BaseInput
                    ...
                    :class="{
                          ...
                          '!shadow-olive': address.editor.isEditing && address.form.valid('floor')
                        }"
                />
                </div>
