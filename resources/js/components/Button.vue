...
export default {
    ...
    computed: {
        mergedClasses() {
            const base = 'cursor-pointer shadow-md hover:shadow-sm duration-500 transition-all ease-in-out flex gap-5 items-center justify-center  md:py-4 my-5 rounded-[12px]';
